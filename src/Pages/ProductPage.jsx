    ...
    useEffect(() => {
        (() => {
            ...
            if (TestimonialStateData.length) {
                setReview(TestimonialStateData.filter(x => x.product?._id === _id))
            }
        })()
        ...
        (() => {
            if (ProductStateData.length) {
                ...
                if (item) {
                    ...
                    setRelatedProducts(ProductStateData.filter(x => x.maincategory === item.maincategory?.name))
                }
                else
                    window.history.back()
            }
                                ...
                                <div className="col-lg-12">
                                    ...
                                    <div className="tab-content mb-5">
                                        ...
                                        <div className="tab-pane" id="nav-mission" role="tabpanel"
                                            ...
                                            {review.length ?
                                                review.map(item => {
                                                    return <div className="d-flex card p-4" key={item._id}>
                                                        <div className="">
